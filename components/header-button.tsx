...
export function HeaderButton({
  ...
  return (
    <>
      {mode === "filled" && (
        <Button className="text-black w-full rounded-sm font-nunito font-bold text-sm bg-gradient-to-r from-[#008D80] to-[#45BF55] cursor-pointer hover:brightness-110">
          {buttonIcon} {text}
        </Button>
      )}
      ...
      {mode === "outlined-red" && (
        <div className="rounded-sm bg-gradient-to-r from-[#F22742] to-[#FF576D] p-[2px]">
          <Button className="w-full bg-[#262626] rounded-sm hover:bg-[#262626] hover:brightness-105 cursor-pointer">
