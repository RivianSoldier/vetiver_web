...
export function LandingPageOurSolutions() {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center min-h-[426px] bg-[#0d0d0d] w-full px-4 py-12 md:p-[40px] xl:p-[90px] gap-14 lg:gap-0 max-w-[1920px]">
