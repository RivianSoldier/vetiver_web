...
export function LandingPageProblems() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-[356px] bg-gradient-to-r from-[#008D80]/15 to-[#45BF55]/15 w-full px-4 py-12 md:p-[40px] xl:p-[90px] gap-12 ">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 max-w-[1920px] w-full px-4">
        <div className="flex flex-col text-center md:text-left md:items-start md:w-[40%] lg:w-[35%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 items-start md:w-[60%] lg:w-[65%]">
          <div className="flex flex-col items-center gap-9">
            ...
            <p className="text-white font-nunito mt-5 text-center text-md">
          ...
          <div className="flex flex-col items-center gap-9 md:col-span-2 lg:col-span-1">
